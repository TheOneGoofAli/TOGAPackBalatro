...
function G.FUNCS.toga_bmplobby(e)
	G.E_MANAGER:add_event(Event({
		func = function() togabalatro.bmplobby() return true end
	}))
end
...
function togabalatro.bmplobbywarn()
	local bmpltxt = G.localization.misc.ui_strings.toga_bmplobbywarn
	play_sound('toga_chord', 1, 0.5)
	return { n = G.UIT.ROOT, config = { align = "cm", colour = clr, padding = 32.01, r = 0.1, minw = 5, id = 'toga_bmplobbywarn'}, nodes = {
		{n = G.UIT.C, config = { align = "cl", outline = 1, outline_colour = HEX('C3C3C3'), colour = G.C.UI.BACKGROUND_INACTIVE, padding = 0.035 }, nodes = {
			{n = G.UIT.R, config = {align = "cl", colour = HEX('000082'), minw = 5}, nodes = {
				{n = G.UIT.C, config = { align = "cl", padding = 0.1 }, nodes = {
					{n = G.UIT.T, config = { text = bmpltxt[1], scale = 0.5, colour = G.C.UI.TEXT_LIGHT }},
				}},
			}},
			{n = G.UIT.R, config = { align = "cl", minw = 5 }, nodes = {
				{n = G.UIT.C, config = { align = "tl", padding = 0.05 }, nodes = {
				...
				{n = G.UIT.C, config = { align = "cl", padding = -0.05}, nodes = {
					{n = G.UIT.R, config = { align = "cl", padding = 0.2 }, nodes = {
						{n = G.UIT.R, config = { align = "cl", padding = -0.05 }, nodes = {
							{n = G.UIT.T, config = { text = bmpltxt[2], scale = 0.5, colour = G.C.UI.TEXT_LIGHT }},
						}},
						{n = G.UIT.R, config = { align = "cl", padding = -0.05 }, nodes = {
							{n = G.UIT.T, config = { text = bmpltxt[3], scale = 0.5, colour = G.C.UI.TEXT_LIGHT }},
						}},
					}},
				}},
			}},
			{n = G.UIT.R, config = {align = "cm", colour = HEX('c0c0c0'), padding = 0.15}, nodes = {
				{n = G.UIT.C, config = { align = "cm" }, nodes = {
					UIBox_button({label = { localize('toga_ok') }, button = "openModUI_TOGAPack", minw = 2, minh = 0.65, colour = HEX('555555')})
				}},
			}},
		}},
	}}
...
function togabalatro.bmplobby()
	G.SETTINGS.paused = true
	G.FUNCS.overlay_menu({
		definition = togabalatro.bmplobbywarn(),
		config = {
			align = "cm",
			offset = {x = 0, y = 0},
			bond = 'Weak',
